...
import { crearAuditoria, obtenerAuditorias, inhabilitarAuditoria, actualizarAuditoria, iniciarAuditoria, registrarRespuesta, finalizarAuditoria, deshabilitarAuditoriaRevertir } from '../controllers/AuditoriaController.js';
...
router.patch(
    '/:id/iniciar',verificarRol([ROLES.ADMIN, ROLES.AUDITOR]), validarSchema(idAuditoriaSchema, 'params'), iniciarAuditoria
);
router.patch(
    '/:id/deshabilitar',verificarRol([ROLES.ADMIN, ROLES.AUDITOR]), validarSchema(idAuditoriaSchema, 'params'), deshabilitarAuditoriaRevertir
);
router.post(
